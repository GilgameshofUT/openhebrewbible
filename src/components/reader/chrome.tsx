      ...
      <section className="about-modal">
        ...
        <ul className="about-credits">
          ...
          <li>
            ...
            <span>Leningrad Codex (Firkovich B 19 A) page images, courtesy of the <a href="https://www.sefaria.org/manuscripts" target="_blank" rel="noreferrer">Sefaria manuscript viewer</a>.</span>
          </li>
        </ul>
      </section>
    </Modal>
