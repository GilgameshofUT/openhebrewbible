      ...
      <section className="about-modal">
        ...
        <ul className="about-credits">
          ...
          <li>
            ...
            <span>Images are embedded or linked from their original providers, never copied or rehosted.</span>
          </li>
        </ul>
      </section>
    </Modal>
  ...
  return (
    <header className="topbar">
      ...
      <div className="top-actions">
        ...
        <a className="social-link" href={CHANNEL_URL} target="_blank" rel="noreferrer" aria-label="Hebrew Bible with Gilgamesh on YouTube"><YouTubeIcon /></a>
      </div>
